                ...
                {contactInfo.map((item) => (
                    <li key={item.link} >
                        ...
                        >
                            ...
                            {item.value}
                            <ArrowUpRight className="h-3 w-3 shrink-0 -translate-x-2 opacity-0 -translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300" />
                        </a>
                    </li>
                ))}
            </ul>
