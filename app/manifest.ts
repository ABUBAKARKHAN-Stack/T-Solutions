...
export default function manifest(): MetadataRoute.Manifest {
    return {
        ...
        icons: [
            ...
            { src: "/assets/brand/favicons/favicon-48x48.png", sizes: "48x48", type: "image/png" },
            { src: "/assets/brand/favicons/favicon-32x32.png", sizes: "32x32", type: "image/png" },
            { src: "/assets/brand/favicons/favicon-16x16.png", sizes: "16x16", type: "image/png" },
            { src: "/assets/brand/favicons/apple-touch-icon.png", sizes: "180x180", type: "image/png" },
        ],
    }
}