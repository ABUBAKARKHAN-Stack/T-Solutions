    ...
    defineField({
      ...
      validation: (R) =>
        R.required()
          .min(5)
          .max(100)
          .warning("Keep the title concise and meaningful"),
    }),
    defineField({
      name: "overviewLabel",
      ...
      validation: (R) =>
        R.required()
          .min(5)
          .max(50)
          .warning("Keep the overvie label concise and meaningful"),
    }),
    defineField({
      name: "slug",
      title: "Slug",
    ...
    defineField({
      ...
      validation: (R) =>
        R.required()
          .min(20)
          .max(300)
          .warning("Short description should be concise"),
    }),
    defineField({
      ...
      type: "text",
      validation: (R) =>
        R.required().min(50).warning("Provide enough detail for the service"),
    }),
    defineField({
      name: "tags",
      title: "Tags",
      ...
      validation: (R) =>
        R.required().min(1).max(10).error("Add at least 1 tag, maximum 10"),
    }),
    defineField({
      name: "deliverables",
      title: "Deliverables",
